...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=46cc712a29352f13b213105d69b47ac7'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyD-UndYNTYbKuZ1Y1A8tabRikx5rRLcE_g'

    SEARCH_ENGINE_ID = 'f2fb35928cce94cd0'
